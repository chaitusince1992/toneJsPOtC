...
//                    console.log("rest_accum.toNotation()="+ rest_accum.toNotation()+" accum.toNotation()="+accum.toNotation());
//                }
...
//                    console.log("duration_array["+i+"]="+duration_array[i]+" accum.toNotation()="+accum.toNotation());
                ...
                isRest = true;
                restValue = processRestNotation(duration_array[i]);
//                console.log("duration_array["+i+"]="+duration_array[i]+" restValue="+restValue+" accum.toNotation()="+accum.toNotation());
...
//
	...
	function mergeDurationVelocityAndPitch(durations, pitches, velocity) {
		if(pitches == "")
			return undefined;
